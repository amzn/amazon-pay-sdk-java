...
public class AuthorizationNotificationWithAdditionalElementsValidTest extends IpnModelTest<AuthorizationNotification> {

    @Override
    protected String getXMLTestFile(){
        return "AuthorizationNotificationWithAdditionalElementsValid.xml";
    }
