...
public class CaptureNotificationWithAdditionalElementsValidTest extends IpnModelTest<CaptureNotification> {

    @Override
    protected String getXMLTestFile() {
        return "CaptureNotificationWithAdditionalElementsValid.xml";
    }
