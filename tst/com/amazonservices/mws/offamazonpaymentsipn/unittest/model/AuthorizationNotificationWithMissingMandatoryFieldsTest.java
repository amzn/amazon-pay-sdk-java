...
public class AuthorizationNotificationWithMissingMandatoryFieldsTest extends IpnModelTest<AuthorizationNotification> {

    @Override
    protected String getXMLTestFile() {
        return "AuthorizationNotificationWithMissingMandatoryFields.xml";
    }
    ...
    public void testObjectToXML() throws Exception {
        String expectedException = "Value for amazonAuthorizationId in com.amazonservices.mws.offamazonpaymentsipn.model.AuthorizationDetails is NULL";
        try {
            testForNull();
            fail();
