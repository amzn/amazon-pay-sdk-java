...
public class ProviderCreditNotificationWithAdditionalElementsValidTest extends IpnModelTest<ProviderCreditNotification> {

    @Override
    protected String getXMLTestFile() {
        return "ProviderCreditNotificationWithAdditionalElementsValid.xml";
    }
