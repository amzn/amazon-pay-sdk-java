...
public class ProviderCreditReversalNotificationValidTest extends IpnModelTest<ProviderCreditReversalNotification> {

    @Override
    protected String getXMLTestFile() {
        return "ProviderCreditReversalNotificationValid.xml";
    }
