...
public class RefundNotificationWithAdditionalElementsValidTest extends IpnModelTest<RefundNotification> {

    @Override
    protected String getXMLTestFile() {
        return "RefundNotificationWithAdditionalElementsValid.xml";
    }
