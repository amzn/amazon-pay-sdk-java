...
public class SolutionProviderMerchantNotificationWithMissingMandatoryFieldsTest extends IpnModelTest<SolutionProviderMerchantNotification> {

    @Override
    protected String getXMLTestFile() {
        return "SolutionProviderMerchantNotificationWithMissingMandatoryFields.xml";
    }
    ...
    public void testObjectToXML() throws Exception {
        String expectedException = "Value for sellerId in com.amazonservices.mws.offamazonpaymentsipn.model.MerchantRegistrationDetails is NULL";
        try {
            testForNull();
            fail();
