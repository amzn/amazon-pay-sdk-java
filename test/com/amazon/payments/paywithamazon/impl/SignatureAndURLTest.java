...
public class SignatureAndURLTest {
    ...
    public void setUp() throws Exception {
        config = new PaymentsConfig(TestConstants.merchantId, TestConstants.accessKey, TestConstants.secretKey).withEnvironment(Environment.SANDBOX).withCurrencyCode(CurrencyCode.USD).withRegion(Region.US);
    ...
    public void testRequestUrlAndSignature() throws Exception{
        ...
        String signature = "GCvjLotlGHHG4SxrFVY8bQ28s%2Fz1a8JkzpHmWJ60GYs%3D";
    ...
    public void testRequestParameterConstructorignature_2() throws Exception{
        ...
        String signature  = "STl3LHCt1933J%2BX4eiX5VDPbNsiZlsJgDMXt%2FhiD1II%3D";
