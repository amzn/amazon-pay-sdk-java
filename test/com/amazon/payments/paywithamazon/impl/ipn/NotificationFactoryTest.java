...
import com.amazon.payments.paywithamazon.response.ipn.model.NotificationType;
...
public class NotificationFactoryTest {
    ...
    public String loadTestFile(String fileName) throws UnsupportedEncodingException, IOException {
        InputStream is = new FileInputStream(System.getProperty("user.dir") +"/test/com/amazon/payments/paywithamazon/impl/ipn/json/" + fileName);
        if (is != null) {
