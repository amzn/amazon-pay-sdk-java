...
public class LoginUserInfoTest {
    ...
    public void setUp() throws Exception {
        ...
        config = new PaymentsConfig(TestConstants.merchantId, TestConstants.accessKey, 
                TestConstants.secretKey).withCurrencyCode(CurrencyCode.USD).withEnvironment(Environment.SANDBOX).withRegion(Region.US);
