 ...
 *       &lt;sequence>
 *         &lt;element name="Amount" type="{http://mws.amazonservices.com/schema/OffAmazonPayments/2013-01-01}NonEmptyString"/>
...
public class Price {
     ...
     *
     */
    public Price(final String amount, final String currencyCode) {
        this.amount = amount;
     ...
     *     this instance
     */
    public Price withAmount(final String value) {
        setAmount(value);
        return this;
    }
     ...
     *     this instance
     */
    public Price withCurrencyCode(final String value) {
