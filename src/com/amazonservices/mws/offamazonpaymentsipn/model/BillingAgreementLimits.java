 ...
 *       &lt;sequence>
 *         &lt;element name="AmountLimitPerTimePeriod" type="{http://mws.amazonservices.com/schema/OffAmazonPayments/2013-01-01}Price"/>
 *         &lt;element name="TimePeriodStartDate" type="{http://www.w3.org/2001/XMLSchema}dateTime"/>
 *         &lt;element name="TimePeriodEndDate" type="{http://www.w3.org/2001/XMLSchema}dateTime"/>
 *         &lt;element name="CurrentRemainingBalance" type="{http://mws.amazonservices.com/schema/OffAmazonPayments/2013-01-01}Price"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "BillingAgreementLimits")
public class BillingAgreementLimits {

    @XmlElement(name = "AmountLimitPerTimePeriod", required = true)
    protected Price amountLimitPerTimePeriod;
    @XmlElement(name = "TimePeriodStartDate", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar timePeriodStartDate;
    @XmlElement(name = "TimePeriodEndDate", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar timePeriodEndDate;
    @XmlElement(name = "CurrentRemainingBalance", required = true)
     ...
     *
     */
    public void setAmountLimitPerTimePeriod(final Price value) {
     ...
     *
     */
    public void setTimePeriodStartDate(final XMLGregorianCalendar value) {
     ...
     *
     */
    public void setTimePeriodEndDate(final XMLGregorianCalendar value) {
     ...
     *
     */
    public void setCurrentRemainingBalance(final Price value) {
     ...
     *     this instance
     */
    public BillingAgreementLimits withAmountLimitPerTimePeriod(final Price value) {
     ...
     *     this instance
     */
    public BillingAgreementLimits withTimePeriodStartDate(final XMLGregorianCalendar value) {
     ...
     *     this instance
     */
    public BillingAgreementLimits withTimePeriodEndDate(final XMLGregorianCalendar value) {
     ...
     *     this instance
     */
    public BillingAgreementLimits withCurrentRemainingBalance(final Price value) {
