...
@XmlRootElement(name = "BillingAgreementStatus")
public class BillingAgreementStatus {
     ...
     *
     */
    public BillingAgreementStatus(final String state, final XMLGregorianCalendar lastUpdateTimestamp, final String reasonCode, final String reasonDescription) {
        this.state = state;
     ...
     *     this instance
     */
    public BillingAgreementStatus withState(final String value) {
        setState(value);
        return this;
    }
     ...
     *     this instance
     */
    public BillingAgreementStatus withLastUpdateTimestamp(final XMLGregorianCalendar value) {
     ...
     *     this instance
     */
    public BillingAgreementStatus withReasonCode(final String value) {
        setReasonCode(value);
        return this;
    }
     ...
     *     this instance
     */
    public BillingAgreementStatus withReasonDescription(final String value) {
