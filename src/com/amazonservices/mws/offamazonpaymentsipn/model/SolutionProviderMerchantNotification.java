...
public class SolutionProviderMerchantNotification extends Notification {
    ...
    public void setMerchantRegistrationDetails(final MerchantRegistrationDetails details) {
        this.merchantRegistrationDetails = details;
    }

    public boolean isSetMerchantRegistrationDetails() {
        return (this.merchantRegistrationDetails != null);
    }
