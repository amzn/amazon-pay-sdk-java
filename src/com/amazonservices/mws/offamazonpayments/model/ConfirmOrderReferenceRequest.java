...
@XmlRootElement(name = "ConfirmOrderReferenceRequest")
public class ConfirmOrderReferenceRequest {
     ...
     *
     */
    public ConfirmOrderReferenceRequest(final String amazonOrderReferenceId, final String sellerId) {
        this(amazonOrderReferenceId, sellerId, ModelConstants.EMPTY_MWS_AUTH_TOKEN);
    }
     ...
     * 
     */
    public ConfirmOrderReferenceRequest(final String amazonOrderReferenceId, final String sellerId, final String MWSAuthToken) {
     ...
     *     this instance
     */
    public ConfirmOrderReferenceRequest withAmazonOrderReferenceId(String value) {
     ...
     *     this instance
     */
    public ConfirmOrderReferenceRequest withSellerId(String value) {
        setSellerId(value);
        return this;
    }
