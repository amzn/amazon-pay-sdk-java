...
public class AuthorizeOnBillingAgreementResult {
     ...
     * 
     */
    public AuthorizeOnBillingAgreementResult(final AuthorizationDetails authorizationDetails, final String amazonOrderReferenceId) {
     ...
     *     this instance
     */
    public AuthorizeOnBillingAgreementResult withAuthorizationDetails(AuthorizationDetails value) {
     ...
     *     this instance
     */
    public AuthorizeOnBillingAgreementResult withAmazonOrderReferenceId(String value) {
