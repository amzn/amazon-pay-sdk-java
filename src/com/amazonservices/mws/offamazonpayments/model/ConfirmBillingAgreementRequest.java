...
@XmlRootElement(name = "ConfirmBillingAgreementRequest")
public class ConfirmBillingAgreementRequest {
     ...
     *
     */
    public ConfirmBillingAgreementRequest(final String sellerId, final String amazonBillingAgreementId) {
        this(sellerId, amazonBillingAgreementId, ModelConstants.EMPTY_MWS_AUTH_TOKEN);
    }
     ...
     * 
     */
    public ConfirmBillingAgreementRequest(final String sellerId, final String amazonBillingAgreementId, final String MWSAuthToken) {
     ...
     *     this instance
     */
    public ConfirmBillingAgreementRequest withSellerId(String value) {
        setSellerId(value);
        return this;
    }
     ...
     *     this instance
     */
    public ConfirmBillingAgreementRequest withAmazonBillingAgreementId(String value) {
