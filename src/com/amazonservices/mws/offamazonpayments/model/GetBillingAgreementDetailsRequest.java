 ...
 *         &lt;element name="AddressConsentToken" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetBillingAgreementDetailsRequest")
public class GetBillingAgreementDetailsRequest {
    ...
    @XmlElement(name = "AddressConsentToken")
    protected String addressConsentToken;
     ...
     *
     */
    public GetBillingAgreementDetailsRequest(final String amazonBillingAgreementId, final String sellerId, final String addressConsentToken) {
        this(amazonBillingAgreementId, sellerId, addressConsentToken, ModelConstants.EMPTY_MWS_AUTH_TOKEN);
    }
     ...
     * 
     */
    public GetBillingAgreementDetailsRequest(final String amazonBillingAgreementId, final String sellerId, final String addressConsentToken, final String MWSAuthToken) {
     ...
     *     
     */
    public void setAddressConsentToken(String value) {
        this.addressConsentToken = value;
    }

    public boolean isSetAddressConsentToken() {
        return (this.addressConsentToken!= null);
    }
     ...
     *     this instance
     */
    public GetBillingAgreementDetailsRequest withAmazonBillingAgreementId(String value) {
     ...
     *     this instance
     */
    public GetBillingAgreementDetailsRequest withSellerId(String value) {
        setSellerId(value);
        return this;
    }
     ...
     *     this instance
     */
    public GetBillingAgreementDetailsRequest withAddressConsentToken(String value) {
        setAddressConsentToken(value);
        return this;
    }
