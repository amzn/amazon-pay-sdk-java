...
public class ProviderCreditSummaryList {
     ...
     * 
     */
    public ProviderCreditSummaryList(final List<ProviderCreditSummary> member) {
        this.member = member;
    }
     ...
     *     this instance
     */
    public ProviderCreditSummaryList withMember(ProviderCreditSummary... values) {
     ...
     *     
     */
    public void setMember(List<ProviderCreditSummary> member) {
        this.member = member;
    }
