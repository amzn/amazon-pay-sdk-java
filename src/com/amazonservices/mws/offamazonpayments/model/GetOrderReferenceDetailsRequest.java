...
@XmlRootElement(name = "GetOrderReferenceDetailsRequest")
public class GetOrderReferenceDetailsRequest {
     ...
     *
     */
    public GetOrderReferenceDetailsRequest(final String amazonOrderReferenceId, final String sellerId, final String addressConsentToken) {
        this(amazonOrderReferenceId, sellerId, addressConsentToken, ModelConstants.EMPTY_MWS_AUTH_TOKEN);
    }
     ...
     * 
     */
    public GetOrderReferenceDetailsRequest(final String amazonOrderReferenceId, final String sellerId, final String addressConsentToken, final String MWSAuthToken) {
     ...
     *     this instance
     */
    public GetOrderReferenceDetailsRequest withAmazonOrderReferenceId(String value) {
     ...
     *     this instance
     */
    public GetOrderReferenceDetailsRequest withSellerId(String value) {
        setSellerId(value);
        return this;
    }
     ...
     *     this instance
     */
    public GetOrderReferenceDetailsRequest withAddressConsentToken(String value) {
