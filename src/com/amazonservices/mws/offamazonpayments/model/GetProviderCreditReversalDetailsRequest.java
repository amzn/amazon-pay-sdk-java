...
@XmlRootElement(name = "GetProviderCreditReversalDetailsRequest")
public class GetProviderCreditReversalDetailsRequest {
     ...
     *
     */
    public GetProviderCreditReversalDetailsRequest(final String sellerId, final String amazonProviderCreditReversalId) {
        this(sellerId, amazonProviderCreditReversalId, ModelConstants.EMPTY_MWS_AUTH_TOKEN);
    }
     ...
     * 
     */
    public GetProviderCreditReversalDetailsRequest(final String sellerId, final String amazonProviderCreditReversalId, final String MWSAuthToken) {
     ...
     *     this instance
     */
    public GetProviderCreditReversalDetailsRequest withSellerId(String value) {
        setSellerId(value);
        return this;
    }
     ...
     *     this instance
     */
    public GetProviderCreditReversalDetailsRequest withAmazonProviderCreditReversalId(String value) {
