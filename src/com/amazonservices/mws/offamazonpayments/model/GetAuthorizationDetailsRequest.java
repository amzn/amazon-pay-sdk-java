...
@XmlRootElement(name = "GetAuthorizationDetailsRequest")
public class GetAuthorizationDetailsRequest {
     ...
     *
     */
    public GetAuthorizationDetailsRequest(final String sellerId, final String amazonAuthorizationId) {
        this(sellerId, amazonAuthorizationId, ModelConstants.EMPTY_MWS_AUTH_TOKEN);
    }
     ...
     *
     */
    public GetAuthorizationDetailsRequest(final String sellerId, final String amazonAuthorizationId, final String MWSAuthToken) {
     ...
     *     this instance
     */
    public GetAuthorizationDetailsRequest withSellerId(String value) {
        setSellerId(value);
        return this;
    }
     ...
     *     this instance
     */
    public GetAuthorizationDetailsRequest withAmazonAuthorizationId(String value) {
