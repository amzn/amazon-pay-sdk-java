...
@XmlRootElement(name = "GetCaptureDetailsRequest")
public class GetCaptureDetailsRequest {
     ...
     *
     */
    public GetCaptureDetailsRequest(final String sellerId, final String amazonCaptureId) {
        this(sellerId, amazonCaptureId, ModelConstants.EMPTY_MWS_AUTH_TOKEN);
    }
     ...
     * 
     */
    public GetCaptureDetailsRequest(final String sellerId, final String amazonCaptureId, final String MWSAuthToken) {
     ...
     *     this instance
     */
    public GetCaptureDetailsRequest withSellerId(String value) {
        setSellerId(value);
        return this;
    }
     ...
     *     this instance
     */
    public GetCaptureDetailsRequest withAmazonCaptureId(String value) {
