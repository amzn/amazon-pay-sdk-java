...
public class RequestHelper {
    ...
    private Map<String,String> addClientParameters(Map<String,String> params) {
     try { 
        ...
        params.put(ServiceConstants.AWSACCESSKEYID , paymentsConfig.getAccessKeyId());
    ...
    private String constructSignature(Map<String, String> params )  {
      try { 
        ...
        String signature = Util.urlEncode(Util.getSignature(stringToSign, paymentsConfig.getSecretAccessKey()));
        return signature;
