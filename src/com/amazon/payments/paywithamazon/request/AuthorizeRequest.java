...
/**
 * Container for the parameters to the {@link com.amazon.payments.lpa.Client#authorize(AuthorizeRequest) Authorize operation}.
...
public class AuthorizeRequest implements Serializable {
    ...
    * be declined. Note: Set this value to zero for synchronous mode.
    * 
    * @param Maximum number of minutes allocated for the Authorize operation
    */
