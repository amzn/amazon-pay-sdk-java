...
public class RefundSample {
   ...
   */
   ...
   RefundResponse response = invokeRefund(service, request, outStream);
  ...
  */
  public static RefundResponse invokeRefund(
    OffAmazonPaymentsService service, RefundRequest request, PrintWriter outStream) {
    try {
    ...
    /**
    * Method to print Refund  response to console

  *@param response instance of RefundResponse
    */
    public static void printResponse(RefundResponse response, PrintWriter outStream){

            int tabLevel = 1;
            outStream.println ("Refund Action Response");
            outStream.println ("=============================================================================");
            outStream.println ();

            Utilities.printVariable("RefundResponse", null, tabLevel, outStream);
            tabLevel++;
            if (response.isSetRefundResult()) {
                Utilities.printVariable("RefundResult", null, tabLevel, outStream);
                RefundResult  refundResult = response.getRefundResult();
                tabLevel++;
