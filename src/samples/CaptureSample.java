...
public class CaptureSample {
   ...
   */
   ...
   CaptureResponse response = invokeCapture(service, request, outStream);
   ...
   */
  public static CaptureResponse invokeCapture(
    OffAmazonPaymentsService service, CaptureRequest request, PrintWriter outStream) {
    try {
    ...
    /**
    * Method to print Capture  response to console
    *
    *@param response instance of CaptureResponse
    */
    public static void printResponse(CaptureResponse response, PrintWriter outStream){

            int tabLevel = 1;
            outStream.println ("Capture Action Response");
            outStream.println ("=============================================================================");
            outStream.println ();

            Utilities.printVariable("CaptureResponse", null, tabLevel, outStream);
            tabLevel++;
            if (response.isSetCaptureResult()) {
                Utilities.printVariable("CaptureResult", null, tabLevel, outStream);
                CaptureResult  captureResult = response.getCaptureResult();
                tabLevel++;
