...
/**
 *
 * Get Billing Agreement Details  Samples
 *
 *
 */
public class GetBillingAgreementDetailsSample {

  /**
   * Just add few required parameters, and try the service
   * Get Billing Agreement Details functionality
   *
   * @param args unused
   */
  public static void main(String... args) {
    ...
    GetBillingAgreementDetailsResponse response = invokeGetBillingAgreementDetails(service, request, outStream);
  ...
  /**
   * Get Billing Agreement Details  request sample

   * @param service instance of OffAmazonPaymentsService service
   * @param request Action to invoke
   */
  public static GetBillingAgreementDetailsResponse invokeGetBillingAgreementDetails(
      OffAmazonPaymentsService service, GetBillingAgreementDetailsRequest request, PrintWriter outStream) {
    try {
      GetBillingAgreementDetailsResponse response =
          service.getBillingAgreementDetails(request);
      return response;
  ...
  /**
   * Method to print Get Billing Agreement Details  response to console

   *@param response instance of GetBillingAgreementDetailsResponse
   */
  public static void printResponse(GetBillingAgreementDetailsResponse response, PrintWriter outStream){

    System.out.println ("GetBillingAgreementDetails Action Response");
    System.out.println ("=============================================================================");
    System.out.println ();

    System.out.println("    GetBillingAgreementDetailsResponse");
    System.out.println();
    if (response.isSetGetBillingAgreementDetailsResult()) {
      System.out.println("        GetBillingAgreementDetailsResult");
      System.out.println();
      GetBillingAgreementDetailsResult  getBillingAgreementDetailsResult = response.getGetBillingAgreementDetailsResult();
      if (getBillingAgreementDetailsResult.isSetBillingAgreementDetails()) {
        System.out.println("            BillingAgreementDetails");
        System.out.println();
        BillingAgreementDetails  billingAgreementDetails = getBillingAgreementDetailsResult.getBillingAgreementDetails();
